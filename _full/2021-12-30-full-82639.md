---
layout: full_article
title: "Full Article Of Pengaruh Jenis Pelarut Terhadap Aktivitas Antioksidan Ekstrak Daun Tenggulun (Protium javanicum Burm. F) Menggunakan Metode Maserasi"
author: "Agnes Citra Yolanda Simamora, Ni Luh Ari Yusasrini, I Nengah Kencana Putra"
description: "Full Article This study was conducted to determine the effect of different solvents on the antioxidant activity of tenggulun leaf extract with the maceration method and to find out t"
categories: itepa
...
<div style="position: relative; width: 100%; max-width: 1000px;">
    ...
    <div style="position: relative; padding-bottom: 100%; overflow: hidden;">
        ...
        <object data="https://jurnal.harianregional.com/pdf/itepa/82639.pdf" type="application/pdf" width="100%" height="100%" style="position: absolute; top: 0; left: 0;">
            ...
            <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: #f8f9fa; display: flex; justify-content: center; align-items: center;">
                ...
                <p>Sorry, your browser does not support embedded PDFs. <a href="https://jurnal.harianregional.com/pdf/itepa/82639.pdf" target="_blank">Click here to view it.</a></p>
            </div>
            <!-- AdSense ad code -->
            <div style="position: absolute; top: 10px; right: 10px; z-index: 9999;">
              {% include inarticle.html %}
